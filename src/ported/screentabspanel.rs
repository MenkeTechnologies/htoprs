//! Stub scaffold for `ScreenTabsPanel.c` — NOT yet ported.
//!
...
//! `ScreenTabsPanel.c`:<line>.` as you go. `gen_port_report.py` counts these
...
pub fn ScreenTabsPanel_delete() {
    todo!("port of ScreenTabsPanel.c:62")
}
...
/// TODO: port of `void ScreenTabsPanel_cleanup(void` from `ScreenTabsPanel.c:178`.
pub fn ScreenTabsPanel_cleanup() {
    todo!("port of ScreenTabsPanel.c:178")
}
