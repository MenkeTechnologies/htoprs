...
/// `OpenBSDProcessTable.c:48` — the C body is a pure teardown:
...
/// end — the `free(this)` (the darwin `ProcessTable_delete` precedent).
pub fn ProcessTable_delete(mut this: OpenBSDProcessTable) {
